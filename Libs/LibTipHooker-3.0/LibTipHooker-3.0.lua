...
Author: Whitetooth@Cenarius (hotdogee@bahamut.twbbs.org). Update for Ace3 by Feithar
...
local MAJOR_VERSION = "LibTipHooker-3.0"
local MINOR_VERSION = tonumber(("$Revision: 67029 $"):sub(12, -3))

if not LibStub then error(MAJOR_VERSION .. " requires LibStub") end

local TipHooker, oldLib = LibStub:NewLibrary(MAJOR_VERSION, MINOR_VERSION)
if not TipHooker then
	return
end
